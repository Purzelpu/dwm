...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_base3, col_base03, col_base03 },
	[SchemeSel]  = { col_base3, col_blue,  col_base01  },
};
...
static const char *dmenucmd[] = { "rofi", "-matching", "fuzzy", "-show", "combi", 
	"-combi-modi", "run,drun", NULL };
